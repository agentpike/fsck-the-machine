...
<div className="fsck-home">
  <div className="fsck-hero">
    <img
      src="fsck-the-machine-cubes-melting-simple.svg"
      alt="fsck The Machine — melting cubes"
      className="fsck-logo"
    />
    <div className="fsck-wordmark">
      <span className="fsck-wordmark-line">fsck The Machine</span>
      <span className="fsck-wordmark-line">fsck Cancer</span>
    </div>
  </div>
</div>
